...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col justify-center items-center bg-gradient-to-br from-[#3e1c5e] to-[#1a0c3e] px-5 py-10 overflow-y-auto">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="grid md:grid-cols-2 grid-cols-1 gap-[100px] w-full max-w-[1200px] p5 box-border"
        >
          {/* Header */}
          <header className="col-span-2 text-center">
            <h1 className="font-bold font-megrim text-[5rem] text-[#ffc107] drop-shadow-lg">
              Ballroom Music Quiz
            </h1>
          </header>
          ...
          <section className="flex flex-col justify-center items-center text-[#e0e0e0] border border-[#ffc107] rounded-lg bg-black/10 p-5 shadow-2xl gap-5">
            <p className="font-bold text-[1.5rem] text-center mb-2">
          ...
          <section className="flex flex-col justify-center items-center text-[#e0e0e0] border border-[#ffc107] rounded-lg bg-black/10 p-5 shadow-lg gap-4">
            <p className="font-bold text-[1.5rem] text-center mb-4">
              Choose Settings:
            </p>
